    ...
    public class Task7Tests
    {
        ...
        public void TestTask()
        {
            var rules = new[]
            {
                ...
                "vibrant cyan bags contain 2 dull beige bags.", "clear fuchsia bags contain 5 bright bronze bags.",
                ...
                "dark teal bags contain 3 mirrored orange bags.", "muted maroon bags contain 5 dim fuchsia bags.",
                ...
                "pale olive bags contain 3 light fuchsia bags.", "dim brown bags contain 2 dotted indigo bags.",
                ...
                "faded fuchsia bags contain 3 dotted gray bags.", "dull beige bags contain 3 posh bronze bags.",
                ...
                "dim magenta bags contain 4 striped orange bags.", "striped teal bags contain 2 dark lime bags.",
                ...
                "vibrant indigo bags contain 3 dotted bronze bags.", "light coral bags contain 2 dotted bronze bags.",
                ...
                "wavy tan bags contain 1 dull lavender bag.", "faded olive bags contain 5 mirrored silver bags.",
                ...
                "plaid silver bags contain 2 bright gold bags.", "faded orange bags contain 5 faded plum bags.",
                ...
                "bright crimson bags contain 1 plaid green bag.", "pale fuchsia bags contain 4 light aqua bags.",
                ...
                "wavy blue bags contain 3 shiny white bags.", "pale lime bags contain 1 dotted maroon bag.",
                ...
                "dark green bags contain 1 striped magenta bag.", "faded blue bags contain 2 dim maroon bags.",
                ...
                "clear white bags contain 1 shiny gold bag.", "dim silver bags contain 5 dull tan bags.",
                ...
                "plaid beige bags contain 3 plaid tomato bags.", "dotted chartreuse bags contain 1 pale maroon bag.",
                ...
                "posh silver bags contain 4 shiny lavender bags.", "shiny orange bags contain 4 light magenta bags.",
                ...
                "dull yellow bags contain 1 dull salmon bag.", "dark maroon bags contain 5 muted turquoise bags.",
                "clear indigo bags contain 5 posh purple bags, 3 striped magenta bags.",
                "shiny olive bags contain 3 drab yellow bags.", "vibrant bronze bags contain 4 plaid indigo bags.",
                ...
                "dark salmon bags contain 5 clear tan bags.", "wavy bronze bags contain 3 dark beige bags.",
                ...
                "striped lavender bags contain 2 wavy aqua bags.", "vibrant red bags contain 1 plaid aqua bag.",
                "shiny yellow bags contain 5 clear silver bags, 2 dull magenta bags, 5 clear turquoise bags.",
                "dull chartreuse bags contain 5 light tan bags.", "bright beige bags contain 2 dim tomato bags.",
                ...
                "posh aqua bags contain 2 mirrored turquoise bags.", "mirrored crimson bags contain no other bags.",
                ...
                "dark indigo bags contain 3 drab purple bags.", "shiny gray bags contain 1 wavy yellow bag.",
                ...
                "wavy red bags contain 3 drab teal bags.", "faded gold bags contain 5 dull lavender bags.",
                ...
                "muted magenta bags contain no other bags.", "striped tomato bags contain 4 shiny gold bags.",
                ...
                "plaid orange bags contain 2 dotted turquoise bags.", "posh magenta bags contain 4 dotted lime bags.",
                ...
                "muted red bags contain 2 mirrored silver bags.", "dotted green bags contain 5 muted plum bags.",
                ...
                "pale brown bags contain 2 wavy black bags.", "bright aqua bags contain 3 plaid tan bags.",
                ...
                "dim bronze bags contain 2 clear turquoise bags.", "light turquoise bags contain 5 dark red bags.",
