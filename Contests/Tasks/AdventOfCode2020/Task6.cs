...
namespace Contests.Tasks.AdventOfCode2020
{
    public static class Task6
    {
        ...
        public static int CountCommonLetters(string input)
        {
            var count = 0;
        ...
        private static readonly Regex Letters = new Regex("[a-z]", RegexOptions.Compiled);
    }
...
a", 1)]
        [TestCase("b", 1)]
        public void TestExample(string input, int expected)
        {
            Task6.CountDistinctLetters(input).Should().Be(expected, $"Input was: {input}");
        }

        [Test]
        public void TestTask()
        {
            var input = @"adgvrhblps
pghsdrbmalv
hrlbpdasgv
bgvsdplahr
