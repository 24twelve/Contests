...
namespace Contests.Tasks.AdventOfCode2020
{
    public static class Task4
    {
        ...
        private static readonly Regex HclRegex = new Regex("^#([a-fA-F0-9]{6})", RegexOptions.Compiled);
        ...
        private static readonly string[] RequiredPassportTags =
        {
            "byr",
            "iyr",
            "eyr",
...
iyr:2011 ecl:brn hgt:59in";
            Task4.CountValidPassports(input).Should().Be(2);
        }

        [Test]
        public void TestValidInvalidByrTag()
        {
            var invalid = @"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1900 iyr:2017 cid:147 hgt:183cm";
            Task4.CountValidPassports(invalid).Should().Be(0);
...
eyr:2022")]
        ...
        public void TestTask1()
        {
            ...
            var input = @"pid:827837505 byr:1976
hgt:187cm
iyr:2016
hcl:#fffffd
eyr:2024
